...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    if (stream === 'true') {
      ...
      const pythonResponse = await fetch(`${PYTHON_SERVICE_URL}/api/research/competitors/stream`, {
        method: 'POST',
        headers: {
      ...
      const pythonResponse = await fetch(`${PYTHON_SERVICE_URL}/api/research/competitors`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
